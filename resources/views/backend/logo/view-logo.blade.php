              ...
              <div class="card-body">
               <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>{{ $key+1 }}</td>
                        <td><img src="{{ (!empty($logo->image)) ? url('upload/logo_images/'.$logo->image):url('upload/no_image.png')}}" width="120px" height="130xp"></td>
                        <td>
                            <a title="Edit" class="btn btn-primary btn-sm" href="{{ route('logos.edit',$logo->id) }}"><i class="fa fa-edit"></i></a>
                            <a title="Delete" id="delete" class="btn btn-danger btn-sm" href="{{ route('logos.delete',$logo->id) }}"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                   </tbody>
