        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Oredr</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
               ...
               <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr class="{{ $order->id }}">
                        ...
                        <td>
                             <a title="Approve" id="approve" class="btn btn-primary btn-sm" href="{{ route('orders.approve',$order->id) }}"><i class="fa fa-check"></i></a>
                        </td>
                    </tr>
                    @endforeach
                   </tbody>
